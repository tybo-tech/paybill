        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeterNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    PrevReading = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerAddress = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CustomerPhone = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    CustomerEmail = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    BillNo = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    BillStatus = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    PrevReading = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CurrentReading = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Usage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PhotoUrl = table.Column<string>(type: "nvarchar(3000)", nullable: true)
                },
                constraints: table =>
                {
